...
function initializeCombat(participants) {
...
function applyDamage(target, amount, damageType) {
    const normalizedCategory = damageType === 'element' ? 'elemental' : damageType;
