...
exports.RUNE_DEFINITIONS = exports.BINDING_RUNE_IDS = void 0;
exports.ensureRuneDesignSafety = ensureRuneDesignSafety;
exports.calculateRuneComplex = calculateRuneComplex;
exports.getDefaultRunePermissionsForRace = getDefaultRunePermissionsForRace;
exports.canCharacterCreateRuneComplex = canCharacterCreateRuneComplex;
exports.canCharacterUseRune = canCharacterUseRune;
exports.applyRuneCost = applyRuneCost;
exports.calculateRuneBacklashChance = calculateRuneBacklashChance;
exports.rollRuneBacklash = rollRuneBacklash;
const races_1 = require("./races");
exports.BINDING_RUNE_IDS = ['hald', 'elgar', 'kragnor', 'nurrak', 'feldr', 'orkann', 'harran'];
...
function ensureRuneDesignSafety(definitions = exports.RUNE_DEFINITIONS) {
...
function isBindingRune(runeId) {
    return exports.BINDING_RUNE_IDS.includes(runeId);
}
...
function calculateRuneComplex(runeDefinitions, runeIds) {
...
function getDefaultRunePermissionsForRace(race) {
    if (race === races_1.Race.Dwarf || race === 'DWARF') {
        return {
...
function canCharacterCreateRuneComplex(character) {
    return character.knowsRuneCraft === true;
}
function canCharacterUseRune(character, rune) {
...
function applyRuneCost(character, cost) {
    return {
        ...character,
...
function calculateRuneBacklashChance(complex, userWillpower) {
...
function rollRuneBacklash(complex, userWillpower) {
