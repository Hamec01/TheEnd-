...
export const ELEMENT_TYPES = ['fire', 'water', 'earth', 'air', 'light', 'dark'];
...
export function getElementCounterMultiplier(attacking, defending) {
    if (!defending) {
        return 1;
    }
...
export function applyElementEffect(target, elementType) {
...
export function checkElementCombo(previousElement, newElement) {
...
export function calculateFinalDamage(input) {
...
export function isEffectBlockedByRace(defender, effect, sourceCategory) {
