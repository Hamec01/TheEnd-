...
export const COMBAT_ACTION_COSTS: Record<CombatActionCostKey, CombatActionCost> = {
  ...
  heavy_attack: { ap: 2, stamina: 35 },
  guard: { ap: 1, stamina: 15 },
  strong_guard: { ap: 1, stamina: 20 },
  weapon_swap: { ap: 1, stamina: 10 },
  use_self_item: { ap: 1, stamina: 5 },
  use_target_item: { ap: 1, stamina: 10 },
  throw_bomb: { ap: 1, stamina: 20 },
  place_trap: { ap: 1, stamina: 15 },
  cast_instant_skill: { ap: 1 },
  cast_heavy_skill: { ap: 2 },
  loot_adjacent: { ap: 1, stamina: 10 },
  start_retreat: { ap: 1, stamina: 10 },
