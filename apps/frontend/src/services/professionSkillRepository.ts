...
const DEFAULT_MINING_SKILL_ICON_BY_NAME: Record<string, string> = {
  ...
  'Подпорки': '/art/mining-skills/Подпорки_1.png',
  'Страховочная верёвка': '/art/mining-skills/Страховочная верёвка_1.png',
  'Тёмный глаз': '/art/mining-skills/Тёмный глаз_1.png',
...
function createDefaultProfessionSkills(): ProfessionSkill[] {
  ...
  return [
    ...
    miningSkill({
      ...
      requiredLevel: 3,
      skillPointCost: 1,
      requiredSkillIds: ['mining_firm_swing', 'mining_careful_strike'],
    ...
    miningSkill({
      ...
      requiredLevel: 3,
      skillPointCost: 1,
      requiredSkillIds: ['mining_work_breathing'],
    ...
    miningSkill({
      ...
      requiredLevel: 4,
      skillPointCost: 1,
      requiredSkillIds: ['mining_stone_hearing', 'mining_ore_habit'],
    ...
    miningSkill({
      ...
      requiredLevel: 8,
      skillPointCost: 2,
      requiredSkillIds: ['mining_support_beams', 'mining_safety_rope', 'mining_heavy_helmet'],
    ...
    miningSkill({
      ...
      requiredLevel: 8,
      skillPointCost: 2,
      requiredSkillIds: ['mining_passage_sense', 'mining_ore_habit'],
    ...
    miningSkill({
      ...
      requiredLevel: 9,
      skillPointCost: 2,
      requiredSkillIds: ['mining_heavy_helmet', 'mining_dust_lungs'],
    ...
    miningSkill({
      ...
      requiredLevel: 12,
      skillPointCost: 3,
      requiredSkillIds: ['mining_heart_of_depth', 'mining_lava_caution', 'mining_last_strike'],
    ...
    miningSkill({
      ...
      requiredLevel: 8,
      skillPointCost: 2,
      requiredSkillIds: ['mining_glimmer_in_stone'],
    ...
    miningSkill({
      ...
      requiredLevel: 8,
      skillPointCost: 2,
      requiredSkillIds: ['mining_sharp_eye', 'mining_soft_strike'],
    ...
    miningSkill({
      ...
      requiredLevel: 12,
      skillPointCost: 3,
      requiredSkillIds: ['mining_blue_vein', 'mining_unbroken_crystal', 'mining_stone_memory'],
    ...
    miningSkill({
      ...
      requiredLevel: 12,
      skillPointCost: 3,
      requiredSkillIds: ['mining_ancient_traces', 'mining_do_not_touch_the_sign', 'mining_stone_whisper'],
