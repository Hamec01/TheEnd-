    ...
    blockTables: [
      ...
      },
      {
        ...
        entries: [
          ...
          { type: 'rich_ore', weight: 14, label: 'Богатая жила', lootTableId: 'mine_loot_teramor_depth_3', payloads: [{ type: 'rune_trace', weight: 2, itemId: 'mat_weak_rune_fragment', minQuantity: 1, maxQuantity: 1, rarity: 'rare', minDepth: 3, tags: ['porter_save_allowed'] }, { type: 'loot_item', weight: 8, itemId: 'mat_iron_ore', minQuantity: 2, maxQuantity: 4 }] },
    ...
    lootTables: [
      {
        ...
        name: 'Терамор I',
        entries: [
          { itemId: 'mat_raw_stone', weight: 40, minQuantity: 1, maxQuantity: 2 },
          { itemId: 'mat_iron_ore', weight: 35, minQuantity: 1, maxQuantity: 2 },
          { itemId: 'mat_gold_nugget', weight: 12, minQuantity: 1, maxQuantity: 1, rarity: 'rare' },
          { itemId: 'mat_cracked_crystal', weight: 8, minQuantity: 1, maxQuantity: 1, rarity: 'rare' },
          { itemId: 'mat_zeptyrite_trace', weight: 5, minQuantity: 1, maxQuantity: 1, rarity: 'rare' },
        ],
        createdAt,
        updatedAt: createdAt,
      },
      {
        ...
        name: 'Терамор II',
        entries: [
          { itemId: 'mat_raw_stone', weight: 28, minQuantity: 1, maxQuantity: 3 },
          { itemId: 'mat_iron_ore', weight: 34, minQuantity: 1, maxQuantity: 3 },
          { itemId: 'mat_gold_nugget', weight: 16, minQuantity: 1, maxQuantity: 2, rarity: 'rare' },
          { itemId: 'mat_cracked_crystal', weight: 12, minQuantity: 1, maxQuantity: 2, rarity: 'rare' },
          { itemId: 'mat_zeptyrite_trace', weight: 10, minQuantity: 1, maxQuantity: 2, rarity: 'epic' },
        ],
        createdAt,
        updatedAt: createdAt,
      },
      {
        ...
        entries: [
          ...
          { itemId: 'mat_iron_ore', weight: 26, minQuantity: 2, maxQuantity: 4 },
          { itemId: 'mat_gold_nugget', weight: 18, minQuantity: 1, maxQuantity: 2, rarity: 'rare' },
          { itemId: 'mat_cracked_crystal', weight: 18, minQuantity: 1, maxQuantity: 2, rarity: 'rare' },
          { itemId: 'mat_zeptyrite_trace', weight: 18, minQuantity: 1, maxQuantity: 3, rarity: 'epic' },
        ],
        createdAt,
        updatedAt: createdAt,
      },
