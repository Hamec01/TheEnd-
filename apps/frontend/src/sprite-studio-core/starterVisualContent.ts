...
function createBodyTemplateFromAsset(params: {
  ...
  return {
    ...
    paperdoll: { imageRef: { type: 'image', src: params.imageId }, scale: 1, offsetX: 0, offsetY: 0, rotation: 0, zLayer: 0 },
    world: { imageRef: { type: 'image', src: params.imageId }, scale: 1, offsetX: 0, offsetY: 0, rotation: 0, zLayer: 0 },
    battle: { imageRef: { type: 'image', src: params.imageId }, scale: 1, offsetX: 0, offsetY: 0, rotation: 0, zLayer: 0 },
