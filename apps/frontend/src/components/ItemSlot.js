...
export const ItemSlot = ({ item, iconEmoji, iconImage, onClick, showPrice = false, price, onDragStart, onDrop, isDragging, }) => {
    ...
    const [tooltipHorizontal, setTooltipHorizontal] = useState('right');
    const [tooltipVertical, setTooltipVertical] = useState('top');
    if (!item) {
