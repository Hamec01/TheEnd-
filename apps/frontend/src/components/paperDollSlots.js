...
export const DWARF_SLOT_RECTS = HUMAN_SLOT_RECTS.map((slot) => ({ ...slot }));
// Temporary calibration baseline copied from human layout; tune independently per race.
export const ELF_SLOT_RECTS = HUMAN_SLOT_RECTS.map((slot) => ({ ...slot }));
export const PAPER_DOLL_ASSETS = {
    HUMAN: {
