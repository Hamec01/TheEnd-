      ...
      onSave: async () => {
        const payload: AdminItem = {
          ...
          professionStats: {
            ...
            transportKind: draft.professionStats?.transportKind ?? draft.transportKind,
            ...
            capacityWeight: draft.professionStats?.capacityWeight ?? draft.capacityWeight,
            capacityLogs: draft.professionStats?.capacityLogs ?? draft.capacityLogs,
            speedModifier: draft.professionStats?.speedModifier ?? draft.speed,
            rentPrice: draft.professionStats?.rentPrice ?? draft.rentPrice,
            rentalDurationHours: draft.professionStats?.rentalDurationHours ?? draft.rentDuration,
            requiresHorse: draft.professionStats?.requiresHorse ?? draft.requiresHorse,
          },
          profession: 'carpenter',
          stackable: false,
        };
