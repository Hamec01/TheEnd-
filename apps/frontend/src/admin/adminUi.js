...
export function AdminFieldLabel({ label, hint }) {
    return (_jsxs("span", { className: `admin-field-label${hint ? ' has-hint' : ''}`, title: hint, children: [label, hint ? _jsx("span", { className: "admin-field-help", "aria-hidden": "true", children: "?" }) : null] }));
}
export function translateItemType(value) {
    switch (value) {
        case 'weapon':
            return 'Оружие';
        case 'armor':
...
export function translateRarity(value) {
    switch (value) {
        case 'common':
            return 'Обычный';
        case 'uncommon':
...
export function translateItemSlot(value) {
    switch (value) {
        case 'head':
            return 'Голова';
        case 'necklace':
...
export function translateHandsRequired(value) {
    switch (value) {
        case 2:
            return 'Двуручное';
        case 1:
...
export function translateDamageCategory(value) {
    switch (value) {
        case 'physical':
            return 'Физический';
        case 'elemental':
...
export function translatePhysicalType(value) {
    switch (value) {
        case 'slash':
            return 'Режущий';
        case 'pierce':
...
export function translateElementType(value) {
    switch (value) {
        case 'fire':
            return 'Огонь';
        case 'water':
...
export function translateMagicSchool(value) {
    switch (value) {
        case 'blood':
            return 'Кровь';
        case 'death':
...
export function translateMerchantType(value) {
    switch (value) {
        case 'blacksmith':
            return 'Кузнец';
        case 'alchemist':
...
export function translateMaterialCategory(value) {
    switch (value) {
        case 'metal':
            return 'Металл';
        case 'wood':
...
export function translateLootSourceType(value) {
    switch (value) {
        case 'npc':
            return 'NPC';
        case 'monster':
...
export function translateStatKey(value) {
    switch (value) {
        case 'hp':
            return 'HP';
        case 'mp':
...
export function translateEnabledState(value) {
